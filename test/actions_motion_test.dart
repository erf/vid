...
void main() {
  ...
  test('motionLineEnd', () {
    ...
    f.text = 'abc def\nghi jkl\n';
    f.createLines();
    expect(Motions.lineEnd(f, Position(l: 0, c: 0)), Position(l: 0, c: 7));
    expect(Motions.lineEnd(f, Position(l: 0, c: 3)), Position(l: 0, c: 7));
    expect(Motions.lineEnd(f, Position(l: 1, c: 0)), Position(l: 1, c: 7));
    expect(Motions.lineEnd(f, Position(l: 1, c: 3)), Position(l: 1, c: 7));
  });
}
