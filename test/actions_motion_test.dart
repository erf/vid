...
void main() {
  test('motionCharNext', () {
    ...
    f.splitLines(e);
    expect(
      CharNextMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 1, l: 0),
    );
    expect(
      CharNextMotion().run(e, f, Position(c: 2, l: 0)),
      Position(c: 3, l: 0),
    );
    expect(
      CharNextMotion().run(e, f, Position(c: 3, l: 0)),
      Position(c: 0, l: 1),
    );
    expect(
      CharNextMotion().run(e, f, Position(c: 0, l: 1)),
      Position(c: 1, l: 1),
    );
    expect(
      CharNextMotion().run(e, f, Position(c: 2, l: 1)),
      Position(c: 3, l: 1),
    );
  });
  ...
  test('motionCharPrev', () {
    ...
    f.splitLines(e);
    expect(
      CharPrevMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 0, l: 0),
    );
    expect(
      CharPrevMotion().run(e, f, Position(c: 2, l: 0)),
      Position(c: 1, l: 0),
    );
    expect(
      CharPrevMotion().run(e, f, Position(c: 0, l: 1)),
      Position(c: 3, l: 0),
    );
    expect(
      CharPrevMotion().run(e, f, Position(c: 2, l: 1)),
      Position(c: 1, l: 1),
    );
  });
  ...
  test('motion.lineUp', () {
    ...
    f.splitLines(e);
    expect(
      LineUpMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 0, l: 0),
    );
    expect(
      LineUpMotion().run(e, f, Position(c: 2, l: 0)),
      Position(c: 2, l: 0),
    );
    expect(
      LineUpMotion().run(e, f, Position(c: 0, l: 1)),
      Position(c: 0, l: 0),
    );
    expect(
      LineUpMotion().run(e, f, Position(c: 2, l: 1)),
      Position(c: 2, l: 0),
    );
  });
  ...
  test('motion.lineUp with emojis', () {
    ...
    f.splitLines(e);
    expect(
      LineUpMotion().run(e, f, Position(c: 2, l: 2)),
      Position(c: 1, l: 1),
    );
    expect(
      LineUpMotion().run(e, f, Position(c: 1, l: 1)),
      Position(c: 2, l: 0),
    );
  });
  ...
  test('motion.lineDown', () {
    ...
    f.splitLines(e);
    expect(
      LineDownMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 0, l: 1),
    );
    expect(
      LineDownMotion().run(e, f, Position(c: 2, l: 0)),
      Position(c: 2, l: 1),
    );
    expect(
      LineDownMotion().run(e, f, Position(c: 0, l: 1)),
      Position(c: 0, l: 1),
    );
    expect(
      LineDownMotion().run(e, f, Position(c: 2, l: 1)),
      Position(c: 2, l: 1),
    );
  });
  ...
  test('motion.lineDown with emojis', () {
    ...
    expect(
      LineDownMotion().run(e, f, Position(c: 1, l: 1)),
      Position(c: 2, l: 2),
    );
  });
  ...
  test('motionFileEnd', () {
    ...
    f.splitLines(e);
    expect(
      FileEndMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 0, l: 1),
    );
    expect(
      FileEndMotion().run(e, f, Position(c: 2, l: 0)),
      Position(c: 0, l: 1),
    );
    expect(
      FileEndMotion().run(e, f, Position(c: 0, l: 1)),
      Position(c: 0, l: 1),
    );
    expect(
      FileEndMotion().run(e, f, Position(c: 2, l: 1)),
      Position(c: 0, l: 1),
    );
  });
  ...
  test('motionWordNext', () {
    ...
    f.splitLines(e);
    expect(
      WordNextMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 4, l: 0),
    );
    expect(
      WordNextMotion().run(e, f, Position(c: 3, l: 0)),
      Position(c: 4, l: 0),
    );
    expect(
      WordNextMotion().run(e, f, Position(c: 4, l: 0)),
      Position(c: 8, l: 0),
    );
    expect(
      WordNextMotion().run(e, f, Position(c: 8, l: 0)),
      Position(c: 0, l: 1),
    );
    expect(
      WordNextMotion().run(e, f, Position(c: 2, l: 1)),
      Position(c: 4, l: 1),
    );
    expect(
      WordNextMotion().run(e, f, Position(c: 2, l: 1)),
  ...
  test('motionWordEnd', () {
    ...
    f.splitLines(e);
    expect(
      WordEndMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 2, l: 0),
    );
    expect(
      WordEndMotion().run(e, f, Position(c: 3, l: 0)),
      Position(c: 6, l: 0),
    );
    expect(
      WordEndMotion().run(e, f, Position(c: 4, l: 0)),
      Position(c: 6, l: 0),
    );
    expect(
      WordEndMotion().run(e, f, Position(c: 8, l: 0)),
      Position(c: 10, l: 0),
    );
    expect(
      WordEndMotion().run(e, f, Position(c: 10, l: 0)),
      Position(c: 2, l: 1),
    );
    expect(
      WordEndMotion().run(e, f, Position(c: 2, l: 1)),
      Position(c: 6, l: 1),
    );
  });
  ...
  test('motionWordPrev', () {
    ...
    f.splitLines(e);
    expect(
      WordPrevMotion().run(e, f, Position(c: 0, l: 0)),
      Position(c: 0, l: 0),
    );
    expect(
      WordPrevMotion().run(e, f, Position(c: 3, l: 0)),
      Position(c: 0, l: 0),
    );
    expect(
      WordPrevMotion().run(e, f, Position(c: 4, l: 0)),
      Position(c: 0, l: 0),
    );
    expect(
      WordPrevMotion().run(e, f, Position(c: 5, l: 0)),
      Position(c: 4, l: 0),
    );
    expect(
      WordPrevMotion().run(e, f, Position(c: 4, l: 1)),
      Position(c: 0, l: 1),
    );
    expect(
      WordPrevMotion().run(e, f, Position(c: 0, l: 1)),
      Position(c: 8, l: 0),
    );
  });
  ...
  test('motionLineEnd', () {
    ...
    f.splitLines(e);
    expect(
      LineEndMotion().run(e, f, Position(l: 0, c: 0)),
      Position(l: 0, c: 7),
    );
    expect(
      LineEndMotion().run(e, f, Position(l: 0, c: 3)),
      Position(l: 0, c: 7),
    );
    expect(
      LineEndMotion().run(e, f, Position(l: 1, c: 0)),
      Position(l: 1, c: 7),
    );
    expect(
      LineEndMotion().run(e, f, Position(l: 1, c: 3)),
      Position(l: 1, c: 7),
    );
  });
