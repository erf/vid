...
extension ActionTypeExt on ActionType {
  ...
  Action get fn => switch (this) {
    ...
    .pasteAfter => const Paste(.after),
    .pasteBefore => const Paste(.before),
    ...
    .openFilePicker => const OpenPopup(.filePicker),
    .openBufferSelector => const OpenPopup(.bufferSelector),
    .openThemeSelector => const OpenPopup(.themeSelector),
    .openDiagnostics => const OpenPopup(.diagnostics),
    ...
    .popupFilterCursorLeft => const PopupFilterCursor(.left),
    .popupFilterCursorRight => const PopupFilterCursor(.right),
    .popupFilterCursorToStart => const PopupFilterCursor(.start),
    .popupFilterCursorToEnd => const PopupFilterCursor(.end),
